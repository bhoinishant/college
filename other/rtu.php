...
<div class="container">
    <br>
<table width="100%" class="table table-fluid" id="myTable"><br>
    <thead>
     <tr class="tro" >
    <td style="width: 30%;"><b>Name</b></td>
    <td style="width: 30%;"><b>Convocation</b></td>
    <td style="width: 10%;"><b>Year</b></td>
    <td style="width: 20%;"><b>RTU Merit</b></td>
    <td style="width: 10%;"><b>Percentage(%)</b></td>
