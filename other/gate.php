...
<style>
  .tro{
    background: rgb(6,0,199);
background: linear-gradient(22deg, rgba(6,0,199,1) 0%, rgba(175,126,82,1) 38%, rgba(240,154,154,1) 71%);
height: 50px;
  }
	td{
		text-align: center;
...
<div class="list-group scroll" target='_blank' id="announcements-inner" style="text-align: left;"><b>
 ...
 <!-- <br> -->
   <div class="panel-heading heading-default">
              <h3 class="panel-title" style="text-align: center;">GATE Result</h3>
   </div>
 
   
<table width='90%' border='3' bgcolor="#00EEFF" align="center" style="margin-top: 5px;">
